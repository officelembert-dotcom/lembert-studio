...
export const metadata = {
  title: 'Notizen — Lembert Studio',
  description: 'Kurze Gedanken von Moritz Lembert. Ein Strom, auf Englisch und Deutsch, je nachdem, in welcher Sprache der Gedanke kam.',
  alternates: {
    canonical: 'https://lembertstudio.com/de/notes',
    languages: {
      'en-GB': 'https://lembertstudio.com/notes',
      'de-CH': 'https://lembertstudio.com/de/notes',
    },
  },
}
...
export default function NotesDe() {
  ...
  return (
    <div className="page-enter mx-auto max-w-page px-6 md:px-10">
      ...
      >
        Kurze Gedanken, auf Englisch und Deutsch, je nachdem, wie sie kamen.
      </p>
