...
import { getRetainedAdvisoryPageDe } from '@/lib/pages'

export const metadata = {
  title: 'Retained Advisory — Langfristige Begleitung für Unternehmer',
  description: 'Eine nachhaltige Advisory-Beziehung über mindestens sechs Monate. Strategische Entscheidungen und die Person, die sie trifft — beides gleichzeitig. Für Gründer und Eigentümer in der Schweiz.',
  openGraph: {
    title: 'Retained Advisory — Lembert Studio',
    description: 'Sechs Monate. Entscheidungen, wie sie kommen. Die Person dahinter.',
  },
  alternates: {
    canonical: 'https://lembertstudio.com/de/work/retained-advisory',
    languages: {
      'en-GB': 'https://lembertstudio.com/work/retained-advisory',
      'de-CH': 'https://lembertstudio.com/de/work/retained-advisory',
    },
  },
}

export default function RetainedAdvisoryDe() {
  const page = getRetainedAdvisoryPageDe()
